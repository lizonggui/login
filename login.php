...
//           echo "<script>console.log(". $test.")</script>";
             if($test){          	
             		echo "<script>
             			     setTimeout(function(){window.location.href='http://127.0.0.1/login/index.html';},800);
                         </script>";//成功输出注册成功
             }else{
                echo '<script>alert("用户名或密码错误");</script>';
                echo "
                  <script>
                          setTimeout(function(){window.location.href='http://127.0.0.1/login/login.html';},1000);
